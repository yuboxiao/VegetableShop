...
public class FinalDb {
	...
	public boolean saveBindId(Object entity) {
		...
		if (entityKvList != null && entityKvList.size() > 0) {
			...
			buildContentValues(entityKvList, cv);
	 ...
	 * @param cv
	 */
	private void buildContentValues(List<KeyValue> list, ContentValues cv) {
	...
	/**
	 * 根据主键查找，同时查找“多对一”的数据（如果有多个“多对一”属性，则查找所有的“多对一”属性的关联数据）
	 * 
	 * @param id
	 * @param clazz
	 */
