...
public class FieldUtils {
	...
	/**
	 * 获取某个属性对应的表的列
	 * 如果字段被注解，则取注解的值，否则直接取字段名
	 * @param field 字段
	 * @return 类中属性对应的表的列名（字段名）
	 */
	...
	public static boolean isManyToOneAndOneToMany(Field field){
		return isManyToOne(field) && isManyToOne(field);
	}
